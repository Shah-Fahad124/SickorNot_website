...
<?php
 session_start();
    ...
    <!-- <div class="flex items-center justify-center p-2"> -->
        <div class="flex h-[100vh] w-[70vw] items-center justify-center mx-auto">
            <div class="flex flex-col h-[90vh] justify-center w-1/2 bg-white py-4 px-8 rounded-lg shadow-xl">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <form class="space-y-4 " method="POST">
                            ...
                            <button type="submit" class="px-4 w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                                Register
                            </button>
                        </form>
